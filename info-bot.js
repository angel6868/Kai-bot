...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  let mentionedJid = [m.sender]
    ...
    let sts = ` – *ɪɴғᴏ ʙᴏᴛ ғᴜʀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ*
...
await conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'ɪ ɴ ғ ᴏ  ғ ᴜ ʀ ɪ ɴ ᴀ',
                    thumbnailUrl: 'https://telegra.ph/file/eb1e900e751c90dcc7661.jpg',
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ғᴜʀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaRI1OB2P59cTdJKZh3q', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
handler.help = ['botstatus']
handler.tags = ['info']
handler.command = /^(infobot|botstatus|statusbot|infofurina)?$/i
