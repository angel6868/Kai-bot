...
let pp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/c792ae431e8b1c23c48d8.jpg')
...
let yaya =`*ʜᴀʟʟᴏ ᴋᴀᴋ👋.* ʙᴇʀɪᴋᴜᴛ ᴀᴅᴀʟᴀʜ ᴄᴏᴍᴍᴀɴᴅ-ᴄᴏᴍᴍᴀɴᴅ ᴍᴇɴᴜ ɢᴇɴsʜɪɴ
...
//conn.sendMessage(m.chat, { video: { url: 'https://btch.pages.dev/file/9c2041b29234af0181726.mp4' }, caption: 'gak tau', viewOnce: false, footer: author }, { quoted: m });
 ...
 conn.sendFile(m.chat, p, '', yaya, m, null, {
  ...
  contextInfo: {
    externalAdReply: {
      ...
      mediaType: 1,
      description: wm,
      title: `${ucapan()} ᴋᴀᴋ ${name}`,
      body: `ɢ ᴇ ɴ s ʜ ɪ ɴ  ᴍ ᴇ ɴ ᴜ`,
renderLargerThumbnail: true,
      thumbnail: await (await fetch (`https://telegra.ph/file/c792ae431e8b1c23c48d8.jpg`)).buffer(),
      sourceUrl: 'https://whatsapp.com/channel/0029VaRI1OB2P59cTdJKZh3q'     
}}}, { quoted: fkon })

let delay = time => new Promise(res => setTimeout(res, time))
let elaina = {
                 audio:fs.readFileSync('./vn/menu2.mp3'),mimetype:'audio/mpeg',ptt:true,viewOnce:false,thumbnaiUrl:thumb
...
handler.help = ['menu']
handler.tags = ['main']
handler.command = /^(menugi|menu-genshin|mgi\?)$/i
