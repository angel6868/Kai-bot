...
let { key } = await conn.sendMessage(m.chat, {text: 'ᴡ ᴀ ɪ ᴛ  ʙ ᴇ ʙ s  ʟ ᴏ ᴀ ᴅ ɪ ɴ ɢ. . .'})//Pengalih isu
...
let tags = {}
const defaultMenu = {
  before: `*こんにちは* %name 🪷、 *Kyzが心を込めて作ったふりなです💞 検索したり、情報を提供したり、ゲームをしたり、いろんなことができます。*
▬▭▬▭▬▭▬▭▬▭▬▭▬▭
 乂  *S T A T I S T I C*
. .╭── ︿︿︿︿︿ .   .   .   .   .   . 
. .┊ ✩*⢄⢁✧ *⌜ ɪɴғᴏ ᴜsᴇʀ ⌟* ✧⡈⡠*✩
...
`.trimStart(),
  ...
  footer: '╰─┄┄─ ╌–╼',
  after: `ғᴜʀɪɴᴀ ᴀɪ ʙʏ ᴋʏᴢ ʜᴀʏᴀɴᴀsɪ ${global.version}`,
}
  try {
    ...
    let bjir = 'https://telegra.ph/file/d4f676686e7df61ea6a96.jpg'
